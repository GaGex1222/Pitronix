const steps = [
  {
    ...
    description:
      "עובד עם כל מצלמת IP שכבר ברשותך. הצוות שלנו מחבר את המצלמות לפלטפורמת הענן של iLand Guard — ללא צורך בביקור טכנאי.",
  },
  {
    number: "02",
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-zinc-400 leading-relaxed">
              ללא חיווט מחדש. ללא עבודות בנייה. iLand Guard משתלבת עם התשתית הקיימת שלך ומופעלת
