const testimonials = [
  {
    quote:
      "לפני Pitronix היו לנו שני פריצות לאתר הבנייה שלנו תוך חודש. מאז שהפעלנו את המערכת — אפס אירועים, ויש לנו התראות להוכיח את זה. הצוות שלהם מגיב מהר יותר מכל שומר שנשכרנו אי פעם.",
    name: "דוד מ.",
    role: "מנהל אתר",
  ...
  {
    quote:
      "אנחנו מפעילים 6 חוות ברחבי הארץ. Pitronix מאפשרת לי לעקוב אחרי הכל מאפליקציה אחת. ה-AI תופס תנועות רכבים בלילה שלגמרי היינו מפספסים. זה מחזיר את עצמו כל שבוע.",
    name: "שרה כ.",
    role: "מנהלת תפעול",
  ...
  {
    quote:
      "חברת הביטוח שלנו בפועל הורידה את הפרמיות שלנו אחרי שהתקנו את Pitronix. הניטור החי ותיעוד האירועים נותנים להם — ולנו — ביטחון אמיתי. אבטחה פרואקטיבית באמת.",
    name: "רון ל.",
    role: "מנהל מתקנים",
